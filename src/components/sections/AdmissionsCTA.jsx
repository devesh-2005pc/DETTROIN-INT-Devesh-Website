  ...
  return (
    <section className={`py-20 relative overflow-hidden transition-colors duration-300 ${
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className={`p-8 sm:p-14 rounded-3xl border shadow-2xl backdrop-blur-2xl text-center space-y-6 ${
          theme === 'light'
          ...
          <div className={`inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-xs font-extrabold uppercase tracking-wider border ${
            ...
            <span>Admissions Session 2026-2027 Open</span>
          </div>

          <h2 className={`font-heading text-3xl sm:text-5xl font-extrabold tracking-tight max-w-3xl mx-auto leading-tight ${
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            <button
              ...
              className="w-full sm:w-auto px-9 py-4 rounded-2xl bg-gradient-to-r from-brand-blue to-brand-sky text-white font-extrabold text-base shadow-xl shadow-brand-blue/40 hover:scale-105 transition-all flex items-center justify-center gap-3 cursor-pointer"
            >
