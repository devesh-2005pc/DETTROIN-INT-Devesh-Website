          ...
          <div className="flex items-center justify-between gap-4">
            ...
            >
              <motion.div 
                ...
                className="w-10 h-10 sm:w-11 sm:h-11 rounded-xl bg-gradient-to-br from-brand-blue to-brand-sky p-0.5 shadow-lg shadow-brand-blue/30"
              >
                <div className="w-full h-full bg-brand-slate rounded-[10px] flex items-center justify-center">
                  <GraduationCap className="w-6 h-6 text-brand-sky group-hover:scale-110 transition-transform duration-300" />
                </div>
              </motion.div>
              
              <div className="flex flex-col">
                <span className={`font-heading font-extrabold text-base sm:text-lg tracking-tight leading-tight transition-colors ${
                  theme === 'light' ? 'text-brand-slate' : 'text-white'
                }`}>
                  EXCELLENCE
                </span>
                <span className="text-[9px] sm:text-[10px] tracking-[0.2em] font-bold text-brand-blue dark:text-brand-sky uppercase opacity-90">
            ...
            <div className="hidden sm:flex items-center gap-2.5 shrink-0">
              ...
              <button
                ...
                className={`flex items-center gap-2 px-3.5 py-2 text-xs font-extrabold rounded-full backdrop-blur-md transition-all duration-200 border cursor-pointer hover:scale-105 active:scale-95 ${
                  theme === 'light'
              ...
              >
                ...
                <span className="relative flex items-center gap-2 px-4 sm:px-5 py-2 rounded-full bg-brand-blue text-white text-xs sm:text-sm font-extrabold transition-all duration-200 group-hover:bg-blue-600 shadow-lg shadow-brand-blue/40">
            ...
            <div className="flex sm:hidden items-center gap-2">
              ...
              <button
                ...
                className={`p-2.5 rounded-xl border transition-colors focus:outline-none cursor-pointer ${
                  theme === 'light'
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div
            ...
            className={`fixed inset-0 z-40 flex flex-col justify-between pt-24 pb-8 px-6 lg:hidden backdrop-blur-2xl ${
              theme === 'light' ? 'bg-white/95 text-slate-900' : 'bg-slate-950/95 text-white'
            }`}
          >
            <div className="space-y-3">
              <div className="text-xs font-extrabold uppercase tracking-widest text-brand-sky mb-4">
                Navigation Menu
              </div>
              {navLinks.map((link, idx) => (
                ...
                >
                  <Link
                    ...
                    className={`flex items-center justify-between py-3.5 px-4 rounded-2xl text-base font-extrabold transition-all cursor-pointer ${
            ...
            <div className="space-y-3 pt-6 border-t border-slate-200/20">
              <button
                ...
                className={`w-full flex items-center justify-center gap-2 py-3 rounded-xl border font-extrabold text-sm transition-colors cursor-pointer ${
                  theme === 'light'
              ...
              <button
                ...
                className="w-full py-3.5 rounded-xl bg-gradient-to-r from-brand-blue to-brand-sky text-white font-extrabold text-sm shadow-lg shadow-brand-blue/40 text-center cursor-pointer"
              >
